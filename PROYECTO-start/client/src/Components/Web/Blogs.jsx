...
const Blogs = () => {
    ...
    useEffect(() => {
        axios.get('http://localhost:8000/api/blog/todos')
            .then(res => {
    ...
    <>
        <div id="home">
            <Navegacion/>
            <section className="page-section section gray-bg mt-5" id="blog">
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-lg-7 text-center">
                            <div className="section-title">
                            <h2 className="page-section-heading text-center text-uppercase text-secondary mb-0">Lista de Blog's</h2>
                            {/* <!-- iconos --> */}
